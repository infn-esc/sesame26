...
{
  auto s = get_string();
  std::vector<String> v(10'000'000, s);
...
int main()
{
  ...
  [[maybe_unused]] char& c1 = s4[4];
  [[maybe_unused]] char const& c2 = s1[4];
...
static_assert(
    std::is_default_constructible_v<String>,
...
static_assert(
    std::is_move_assignable_v<String>,
    "String is not move assignable"
);
static_assert(
    std::is_destructible_v<String>,
    "String is not destructible"
);
static_assert(
    std::is_nothrow_default_constructible_v<String>,
...
static_assert(
    !std::is_nothrow_copy_assignable_v<String>,
...
static_assert(
    std::is_nothrow_move_assignable_v<String>,
    "String is not noexcept move assignable"
);
static_assert(
    std::is_nothrow_destructible_v<String>,
